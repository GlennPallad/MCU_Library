...
int main(int argc, char const *argv[])
{
	...
	NRF_Configuration(nrf_PTX_MODE);
...
void vTask1( void *pvParameters )
{
	...
	TickType_t xDelay1ms = pdMS_TO_TICKS(1);
	/* As per most tasks, this task is implemented in an infinite loop. */
	for ( ; ; )
	{
		// if (flicker == 1)
		// {
		// 	USART_SendString(USART1, "USART1 periodic test, flicker = 1.\n");
		// 	flicker = 0;
		// } else {
		// 	USART_SendString(USART1, "USART1 periodic test, flicker = 0.\n");
		// 	flicker = 1;
		// }
